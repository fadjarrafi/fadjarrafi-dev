...
`[basket1, basket2] = [basket2, basket1];` This line swaps all the contents of basket1 and basket2. It's like exchanging the entire baskets in one swift motion. Next we will learn how we can destruct the objects we have.

[Destructuring Object in JS](https://fadjarrafi.com/blog/destructuring-object)
